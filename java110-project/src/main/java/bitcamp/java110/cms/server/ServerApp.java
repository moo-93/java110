...
public class ServerApp implements Servlet{
    ...
    public void init(ServletConfig config) throws ServletException {
        // 서블릿 컨테이너는
        // 이 서블릿 객체를 생성한 후 
        // 이 서블릿이 실행하는데 필요한 자원을 준비할 수 있도록 딱 한 번 호출한다.
    ...
    public String getServletInfo() {
        // 서블릿 컨테이너 관리자화면에서 이 서블릿의 정보를 출력할 때 이 메서드를 호출한다.
    ...
    public void destroy() {
        ...
        // 왜냐하면 이 서블릿이 사용했던 자원을 해제시켜 메모리를 줄일 수 있도록 하기 위함이다.
        // ex) DB 연결된 것을 닫는다거나 열린 파일을 닫는다거나,
