...
<body>
   <h1>지시부(Directive Element) - taglib</h1>
   <pre>
   ...
   - JSTL?
     ...
     JSTL의 명세는 JavaEE 표준 기술이다.
             ...
             외부에서 JSTL 명세에 따라 구현된 외부 라이브러리를 사용해야 한다.
   - JSTL 사용법 ?
     JSTL 명세에 따라 만든 자바 라이브러리(.jar)를 웹 애플리케이션에 추가한다.
   ...
   <hr>
<ul>
<c:forTokens var="name" items="홍길동,유관순,윤봉길,안중근" delims=",">
    <li>${name}</li>
 </c:forTokens>
</ul>
