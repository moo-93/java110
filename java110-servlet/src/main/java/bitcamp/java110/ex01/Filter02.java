// 필터 만들기
// - javax.serverlet.Filter 인터페이스 구현
...
// 필터를 만들었으면 어떤 요청에 대해 실행할 것인지 등록해야한다.
// URL은 반드시 "/로 시작해야한다.
//@WebFilter("/ex01/*")
public class Filter02 implements Filter {
    ...
    public void doFilter(ServletRequest request
        ...
        // 이때 이 메서드가 호출된다.
        // 서블릿을 실행하기 전,후에 수행되야 할 작업이 있다면 이 메서드에서 실행한다.
        // 예) 서블릿을 실행하기 전에 하는 일:
        ...
        // - 클라이언트가 로그인 한 사용자인지 검사한다.
        System.out.println("Filter02.doFilter() --- before");
        // => 다음 필터가 있다면 실행하고 없다면 서블릿을 호춯하게 한다.
