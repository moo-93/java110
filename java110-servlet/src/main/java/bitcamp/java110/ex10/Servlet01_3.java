 ...
 *    그래서 웹 브라우저는 쿠키의 유효기간 동안에는 서버에서 쿠키를 제시한다.
...
public class Servlet01_3 extends HttpServlet{
    ...
    public void doGet(
        ...
        /* HTTP 응답 프로토콜 예)
         * HTTP/1.1 200
           Set-Cookie: name=honggildong; Path=/
           Set-Cookie: age=12; Max-Age=60; Expires=Mon, 01-Oct-2018 03:34:55 GMT <==== 종료날짜 지정됨
           Set-Cookie: working=true; Max-Age=86400; Expires=Tue, 02-Oct-2018 03:33:55 GMT <==== 종료날짜 지정됨
           Content-Type: text/html;charset=UTF-8
           Content-Length: 140
           Date: Mon, 01 Oct 2018 02:50:58 GMT
         */
