...
public class Servlet21 extends HttpServlet{
    ...
    protected void doGet(
        ...
        // => 있다면,
        //    => 웹 브라우저가 제시한 세션 아이디에 해당하는 세션 객체를 찾는다.
        //    => 있다면, 유효하다면,
        //       그 세션 객체를 리턴한다.
        //       웹 브라우저가 세션 아이디를 갖고 있기 때문에
        //       응답할 때 프로토콜에 쿠키로 다시 세션 아이디를 보내지 않는다.
        //    => 있다면, 그러나 timeout 되어 무효 하다면,
        //       없을 때와 똑같이 처리한다.
        //    => 없다면,
        //       없을 때와 똑같이 처리한다.
        // => 없다면,
        ...
        //    => 웹 브라우저는 서버로부터 받은 쿠키데이터인 세션ID를
        //       서버에 요청할 때 마다 보낼 것이다.
        
        //세션 ID를 응답 프로토콜로 보내는 예)
        // => 톰켓 서버에서는 JSESSIONID라는 쿠키 이름으로 세션 아이디를 보낸다.
        // => WAS 마다 세션ID의 쿠키이름이 다를 수 있다.
        /*HTTP/1.1 200
        Set-Cookie: JSESSIONID=45EB18CF32519AE1384B44C91CDF4A76; Path=/; HttpOnly
        Content-Type: text/html;charset=UTF-8
        Content-Length: 143
        Date: Tue, 02 Oct 2018 00:37:16 GMT*/
