...
public class Test29 {
    ...
    @GetMapping("m2")
    public void m2(Model model, HttpSession session) throws Exception{
        System.out.println("Test29.m2()...");
    }
    
    @GetMapping("ok/m3")
    public void m3(Model model, HttpSession session) throws Exception{
        System.out.println("Test29.m3()...");
    }
    
    @GetMapping("no/m4")
    public void m4(Model model, HttpSession session) throws Exception{
