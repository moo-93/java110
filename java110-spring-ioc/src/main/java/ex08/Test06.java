...
// => 이 에노테이션은 JSR-250에서 제안한 에노테이션이다.
//    Java에 기본으로 포함되어 있지 않기 때문에
//    JSR-250 명세에 따라 작성된 외부 라이브러리를 추가해야 한다.
//    mavenrepository.com에서 "javax.annotation"으로 겁색하라!
//
// JSR(Java Specification Requests)?
// => Java에 기본 라이브러리로  포함시키기를 요구하는 명세이다.
// => JCP에서 제안한다.
...
// => 오라클, 마이크로소프트, IBM, 페이스북, 삼성, LG등 유수 IT 기업이 참여하고 있따.
package ex08;
